...
% ns(nnodes+13)=2;
% ns(nnodes+14)=2;
ns=[2 3 2 2 2 2 2 3 3 3 3 3 3 2 3 2 2 2 2 2 3 3 3 3 3 3];
...
% draw_graph(bnet.dag)
    ...
    [bnet2, LLtrace] = learn_params_dbn_em(engine, traindata, 'max_iter', 5);%, 'init_temp', 10, 'thresh', 1e-10);%, 'anneal', 0.8);
